...
const details: Record<CancerType, Detail> = {
  ...
  breast: {
    ...
    sources: [
      { label: 'ACS breast screening guidance', url: 'https://www.cancer.org/cancer/types/breast-cancer/screening-tests-and-early-detection.html' },
      { label: 'CDC cancer screening overview', url: 'https://www.cdc.gov/cancer/prevention/screening.html' },
  ...
  cervical: {
    ...
    sources: [
      { label: 'ACS cervical screening guidance', url: 'https://www.cancer.org/cancer/types/cervical-cancer/detection-diagnosis-staging/cervical-cancer-screening-guidelines.html' },
  ...
  colorectal: {
    ...
    sources: [
      ...
      { label: 'ACS screening guidelines', url: 'https://www.cancer.org/cancer/screening/american-cancer-society-guidelines-for-the-early-detection-of-cancer.html' },
    ],
  },
  prostate: {
    ...
    sources: [
      { label: 'ACS prostate screening guidance', url: 'https://www.cancer.org/cancer/types/prostate-cancer/detection-diagnosis-staging/acs-recommendations.html' },
  ...
  liver: {
    ...
    sources: [
      { label: 'ACS liver cancer early detection', url: 'https://www.cancer.org/cancer/types/liver-cancer/detection-diagnosis-staging/detection.html' },
    ],
  },
  skin: {
    ...
    sources: [
      { label: 'CDC cancer screening overview', url: 'https://www.cdc.gov/cancer/prevention/screening.html' },
      { label: 'ACS skin cancer information', url: 'https://www.cancer.org/cancer/types/skin-cancer.html' },
    ],
  },
  'oral-hpv': {
    ...
    sources: [
      ...
      { label: 'ACS oral and oropharyngeal cancer information', url: 'https://www.cancer.org/cancer/types/oral-cavity-and-oropharyngeal-cancer.html' },
    ],
  },
};
