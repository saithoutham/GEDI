...
const details: Record<CancerType, Detail> = {
  ...
  breast: {
    eligible: 'Average-risk people assigned female at birth can usually start routine mammography at 40. USPSTF recommends screening every 2 years from ages 40 to 74.',
  ...
  cervical: {
    eligible: 'Average-risk people who need cervical screening generally start at 21 and continue through 65. USPSTF screening options depend on age and test type.',
  ...
  prostate: {
    eligible: 'Prostate screening is usually a shared decision. USPSTF recommends discussing PSA-based screening with a clinician from ages 55 to 69.',
