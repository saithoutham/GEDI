    ...
    <section className="container-gedi py-14 md:py-20">
      <div className="max-w-4xl">
        ...
        <p className="body-lg mt-5 text-[var(--color-ink-muted)]">
          This guide cites USPSTF, CDC, NCI, and peer-reviewed sources where GEDI has enough information. It is educational and should be reviewed with a licensed clinician.
        </p>
      </div>
